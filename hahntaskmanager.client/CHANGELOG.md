...
- Create Angular project with ng: `ng new hahntaskmanager.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`hahntaskmanager.client.esproj`).
